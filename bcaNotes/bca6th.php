...
<body>
  ...
  <section class="py-5 text-center text-light hero-bca mainContent">
    <div class="container">
      <h1 class="fw-bold mb-3">BCA Semester 6th</h1>
      <p class="lead mb-4">
        In the semester 1st, there are four subjects: CNS , ISADI, EC, CC.
      </p>
  ...
  <section class="py-5 text-center text-light hero-notes">
      <div class="container contents">
        <h1 class="fw-bold mb-3">BCA Sem 6th Subjects Notes</h1>
        <p class="lead mb-0">
         In 6th Semester there are four subjects, and we provided four subject's Notes(PDF's).
        </p>
      </div>
    </section>
