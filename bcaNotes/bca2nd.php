...
<body>
    ...
    <div class="container">
      <h1 class="fw-bold mb-3">BCA Semester 2nd</h1>
      <p class="lead mb-4">
       In the semester 2nd, there are five subjects: MATH, Adc C, CAAL, POM, FAT and there are two practical (Adc C, FAT).
      </p>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb justify-content-center mb-0">
          ...
          <li class="breadcrumb-item">
            <a href="" class="text-light text-decoration-none">BCA Sem 2nd</a>
          </li>
        </ol>
      </nav>
    </div>
   ...
   <section class="py-5 text-center text-light hero-notes">
      <div class="container contents">
        <h1 class="fw-bold mb-3">BCA Sem 2nd Subjects Notes</h1>
        <p class="lead mb-0">
         In 2nd Semester there are five subjects, and we provided five subject's Notes(PDF's).
        </p>
      </div>
    </section>
    <div class='container'>
