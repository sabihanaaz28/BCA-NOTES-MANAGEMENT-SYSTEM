...
<body>
  ...
  <section class="py-5 text-center text-light hero-bca mainContent">
    <div class="container">
      <h1 class="fw-bold mb-3">BCA All Semester Programming</h1>
      <p class="lead mb-4">
        In the semesters, there are five subjects and there are two or three programming language per semester.
      </p>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb justify-content-center mb-0">
          ...
          <li class="breadcrumb-item">
            <a href="" class="text-light text-decoration-none">Programming</a>
          </li>
        </ol>
      </nav>
    </div>
    ...
    <!-- create a section  -->
     <section class="py-5 text-center text-light hero-notes">
      <div class="container contents">
        <h1 class="fw-bold mb-3">BCA All Sem Programming Codes</h1>
        <p class="lead mb-0">
         In All Semester there are multiple programming subjects, and we provided all programming subject's Codes(PDF's).
        </p>
    ...
    <main class="py-5 main-notes">
        ...
        <div class="row g-4 justify-content-center">
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <a href="web.php" class="btn btn-outline-primary w-100 py-3">
              <i class="fa-solid fa-book me-2"></i> Web Designing
            </a>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <a href="programming.php" class="btn btn-outline-primary w-100 py-3">
              <i class="fa-solid fa-book me-2"></i> Web Programming
            </a>
          </div>
        </div>
        </div>
