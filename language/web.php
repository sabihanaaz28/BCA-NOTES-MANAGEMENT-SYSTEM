...
<body>
  ...
  <section class="py-5 text-center text-light hero-bca mainContent">
    <div class="container">
      <h1 class="fw-bold mb-3">Web Designing</h1>
      <p class="lead mb-4">
        In this semester there are 3 web designing HTML, CSS, JS.
      </p>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb justify-content-center mb-0">
          ...
          <li class="breadcrumb-item">
            <a href="" class="text-light text-decoration-none">Web Designing</a>
          </li>
        </ol>
      </nav>
    </div>
  ...
  <section class="py-5 text-center text-light hero-notes">
      <div class="container contents">
        <h1 class="fw-bold mb-3">Web Designing Codes</h1>
        <p class="lead mb-0">
         In this Semester there are 3 web designing, and we provided six programming language's Code(PDF's).
        </p>
      </div>
    </section>
    <div class='container'>
