...
<body>
  ...
  <section class="py-5 text-center text-light hero-bca mainContent">
    <div class="container">
      <h1 class="fw-bold mb-3">BCA Semester 1st Exam Paper</h1>
      <p class="lead mb-4">
        Question papers of these exams are available here: PPA Paper, CFOA Paper, DE Paper, BC Paper, Math Paper, ES Paper.
      </p>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb justify-content-center mb-0">
          ...
          <li class="breadcrumb-item">
            <a href="" class="text-light text-decoration-none">BCA Sem 1st</a>
          </li>
        </ol>
      </nav>
    </div>
  ...
  <section class="py-5 text-center text-light hero-notes">
      <div class="container contents">
        <h1 class="fw-bold mb-3">BCA Sem 1st Exam Papers PDF</h1>
        <p class="lead mb-0">
         In 1st Semester there are six subjects, and we provided six subject's exam papers PDF.
        </p>
      </div>
    </section>
     <div class='container'>
        <div class="contentSub">
            <div class="subject">
                ...
                <div class="clickPdf">
                    <p><a href="../pdf/Programmin_in_c.pdf" class="clickpdf1">Download</a></p>
                </div>
            </div>
        </div>
        <div class="contentSub">
            <div class="subject">
                ...
                <div class="clickPdf">
                    <p><a href="../pdf/CFOA.pdf" class="clickpdf1">Download</a></p>
                </div>
            </div>
        </div>
        <div class="contentSub">
            <div class="subject">
                ...
                <div class="clickPdf">
                    <p><a href="../pdf/DECO.pdf" class="clickpdf1">Download</a></p>
                </div>
            </div>
        </div>
        <div class="contentSub">
            <div class="subject">
                ...
                <div class="clickPdf">
                    <p><a href="../pdf/BC PYQ.pdf" class="clickpdf1">Download</a></p>
                </div>
            </div>
        </div>
        <div class="contentSub">
            <div class="subject">
                ...
                <div class="clickPdf">
                    <p><a href="../pdf/Math.pdf" class="clickpdf1">Download</a></p>
                </div>
            </div>
        </div>
        <div class="contentSub">
            <div class="subject">
                ...
                <div class="clickPdf">
                    <p><a href="../pdf/EVS.pdf" class="clickpdf1">Download</a></p>
                </div>
            </div>
        </div>
</div> 
