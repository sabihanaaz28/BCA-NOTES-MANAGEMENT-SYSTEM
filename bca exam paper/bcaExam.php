...
<body>
  ...
  <section class="py-5 text-center text-light hero-bca mainContent">
    ...
    <div class="container">
      <h1 class="fw-bold mb-3">BCA Exam Papers</h1>
      <p class="lead mb-4">
        Bca all semesters exam papers are available here.
      </p>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb justify-content-center mb-0">
          ...
          <li class="breadcrumb-item">
            <a href="" class="text-light text-decoration-none">Exam Papers</a>
          </li>
        </ol>
      </nav>
    </div>
  ...
  <section class="py-5 text-center text-light hero-notes">
      <div class="container contents">
        <h1 class="fw-bold mb-3">BCA All Sem Exam Papers PDF</h1>
        <p class="lead mb-0">
          In All Semester there are multiple subjects, and we provided all subject's exam papers PDF's.
        </p>
      </div>
    </section>
    <!-- create a main content -->
     <main class="py-5 main-notes">
      <div class="container">
        <div class="row g-4 justify-content-center">
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <a href="bcaExam1.php" class="btn btn-outline-primary w-100 py-3">
              <i class="fa-solid fa-book me-2"></i> BCA Sem 1st
            </a>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <a href="bcaExam2.php" class="btn btn-outline-primary w-100 py-3">
              <i class="fa-solid fa-book me-2"></i> BCA Sem 2nd
            </a>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <a href="bcaExam3.php" class="btn btn-outline-primary w-100 py-3">
              <i class="fa-solid fa-book me-2"></i> BCA Sem 3rd
            </a>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <a href="bcaExam4.php" class="btn btn-outline-primary w-100 py-3">
              <i class="fa-solid fa-book me-2"></i> BCA Sem 4th
            </a>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <a href="bcaExam5.php" class="btn btn-outline-primary w-100 py-3">
              <i class="fa-solid fa-book me-2"></i> BCA Sem 5th
            </a>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <a href="bcaExam6.php" class="btn btn-outline-primary w-100 py-3">
