...
<head>
    ...
    <title>BCA Exam Paper Sem 6th</title>
...
<body>
  ...
  <section class="py-5 text-center text-light hero-bca mainContent">
    <div class="container">
      <h1 class="fw-bold mb-3">BCA Semester 6th Exam Paper</h1>
      <p class="lead mb-4">
        Question papers of these exams are available here: CNS Paper, ADI Paper, EC Paper, CC Paper.
      </p>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb justify-content-center mb-0">
          ...
          <li class="breadcrumb-item">
            <a href="" class="text-light text-decoration-none">BCA Sem 6th</a>
          </li>
        </ol>
      </nav>
    </div>
    ...
    <section class="py-5 text-center text-light hero-notes">
      <div class="container contents">
        <h1 class="fw-bold mb-3">BCA Sem 6th Exam Papers PDF</h1>
        <p class="lead mb-0">
         In 6th Semester there are four subjects, and we provided four subject's exam papers PDF.
        </p>
      </div>
    </section>
     <div class='container'>
        ...
        <div class="contentSub">
            <div class="subject">
                ...
                <div class="clickPdf">
                    <p><a href="../pdf/ADI.pdf" class="clickpdf1">Download</a></p>
                </div>
            </div>
        </div>
        <div class="contentSub">
            <div class="subject">
                ...
                <div class="clickPdf">
                    <p><a href="../pdf/E_Com.pdf" class="clickpdf1">Download</a></p>
                </div>
            </div>
        </div>
        <div class="contentSub">
            <div class="subject">
                ...
                <div class="clickPdf">
                    <p><a href="" class="clickpdf1">Download</a></p>
                </div>
            </div>
        </div>
</div> 
